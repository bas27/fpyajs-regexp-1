## Никнеймы (Домашнее задание к лекции «Регулярные выражения») [![Build status](https://ci.appveyor.com/api/projects/status/wpltcirj77bttyl5?svg=true)](https://ci.appveyor.com/project/bas27/fpyajs-regexp-1)
